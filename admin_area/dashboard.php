...
// need to solve the problem for getting costumer id in first column 
...
// Add the code here to retrieve and display customer email
$get_customer = "SELECT * FROM customers WHERE customer_id='$c_id'";
$run_customer = mysqli_query($con, $get_customer);

if (!$run_customer) {
    die("Error executing the customer query: " . mysqli_error($con));
}

$row_customer = mysqli_fetch_array($run_customer);

if ($row_customer !== null && isset($row_customer['customer_email'])) {
    $customer_email = $row_customer['customer_email'];
    echo $customer_email;
} else {
    echo "Customer email not found or customer does not exist.";
}
?>
</td>
