...
<td>
<input type="checkbox" name="remove[]" value="<?php echo $pro_id; ?>"> <!-- need to add deleted option from wishlist -->
</td>
...
<h3 class="text-center"> You may like these Products </h3> <!-- needed to adjust -->

<div id="row same-height-row"><!-- row same-height-row Starts -->

<div class="col"><!-- col-md-3 col-sm-6 Starts -->
