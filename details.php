...
<!-- <script>
  ...
  function add() {
    var quantity = document.getElementsByName('product_qty')[0].value;
    var size = document.getElementsByName('product_size')[0].value;
    
    if (quantity === 'Select quantity' || size === '') {
...
<div id="row same-height-row-10"><!-- row same-height-row Starts -->
...
?>
<p style= >products you may like</p> <!-- need to adjust this -->

<div class="col-md col-sm"><!-- col-md-3 col-sm-6 Starts -->
